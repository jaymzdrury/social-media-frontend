export const categories = [
  ...
  export const feedQuery = `*[_type == "pin"] | order(userId asc) {
    image{
      asset->{
        url
      }
  ...
  export const userCreatedPinsQuery = (userId: string) => {
    const query = `*[ _type == 'pin' && postedBy->_id == '${userId}'] | order(_createdAt desc){
      image{
        asset->{
          url
        }
  ...
  export const userSavedPinsQuery = (userId: string) => {
    const query = `*[_type == 'pin' && postedBy->_id == '${userId}' in save[].userId ] | order(_createdAt desc) {
      image{
        asset->{
          url
        }
